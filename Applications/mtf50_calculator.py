...
import cv2
import os
from mtf50_image_processor import ImageProcessor
...
class MTF50Processor:
    ...
    def process_frame(self, frame):
        ...
        if self.roi_selected:
            if self.selected_roi:
                ...
                mtf_computer = ImageProcessor(gray, show=False)  # 使用 ImageProcessor 來計算 MTF50
    ...
    def process_from_image(self, folder_path):
        ...
        for image_file in image_files:
            ...
            mtf_computer = ImageProcessor(gray, show=True)  # 使用 ImageProcessor 來計算 MTF50
            mtf50 = mtf_computer.MTF()
            mtf50_rounded = round(mtf50, 3) if mtf50 is not None else None
